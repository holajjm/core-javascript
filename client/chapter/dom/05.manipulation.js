...
document.body.insertAdjacentHTML('beforeend','<div class="tiger">멋쟁이사자처럼</div>')
...
const template = '<li class="list">watch movie</li>'
h1.insertAdjacentElement('beforebegin', template)
...
insertLast('body', template) //beforeend
