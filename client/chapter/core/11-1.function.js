...
//     //validation
//     if(!a || !b){
//         throw new Error('calcPrice first and second parameter is neccessary');
//     }
//     console.log(a+b+c+d);
// }
// calcPrice() // argument(인수)
...
function setStyle(node,prop,value){
  ...
  if(typeof prop !== 'string'){
    throw new Error('setStyle 함수의 두번째 인수는 문자 타입입니다.');
  }
  if(!value) throw new Error('setStyle 함수의 세번째 인수는 필수 입력값입니다.');
