...
//enumerable : 열거 가능한
//immutable : 불변의 -> Object.freeze(obj);라는 method로 설정 가능하다. = configurable false
//iterable : 반복 가능한 -> Symbol.iterator
...
//   for(let value of languages){
//     const name = value.name;
//     if(name.includes('java')) continue;
//     console.log(value);
//   }
...
console.log(Object.keys(randomUser)); //객체의 key를 배열로 반환
console.log(Object.values(randomUser)); // 객체의 value를 배열로 반환
console.log(Object.entries(randomUser)); // key,value를 가진 하나의 쌍 배열로 반환
