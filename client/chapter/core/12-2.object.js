...
//mixin 방식(얕은 복사) : 아예 새로운 객체를 생성하는 방식(객체 병합/합성)
const combine = Object.assign({}, cssMapA, cssMapB);
//spread syntax(얕은 복사)
const spread = {...cssMapA, ...cssMapB};
