    ...
    return /*html*/`
        <article class="user-card" data-index="user-${id}">
            ...
            <div class="user-resouce-info">
                ...
                <div>
                    <a class="user-website" href="http://tiger.com" target="_blank"
...
function createSpinner(size=100,loadingMessage='Loading...'){
    return `
        <figure class="lodingSpinner">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;background:#999;display:block;" width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" preserveAspectRatio="xMidYMid">
            ...
            <figcaption style="text-align: center;">${loadingMessage}</figcaption>
        </figure>
    `
}
